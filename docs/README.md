...
- [operations/adding-a-service.md](operations/adding-a-service.md) — the golden-path recipe for wiring a new service onto the compute layer, via the `/new-service` command or manually from `services/_template/`.
