...
- [console-access.md](console-access.md) — the two console-only IAM access levels (DynamoDB data users, one administrator), what each can/can't do, sign-in + MFA-enrollment steps, and how they're provisioned. Covers [PRD platform/0007](../action_plan/platform/0007-dynamodb-console-users.md).
